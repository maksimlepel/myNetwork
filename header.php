...
if (isset($_SESSION['user'])) {
    ...
    $loggedin = FALSE;
echo <<<_MAIN
 <title>Maksim's Nest: $userstr</title>
 </head>
 <body>
 <div data-role='page'>
 <div data-role='header'>
 <div id='logo'
 class='center'>M<img id='robin' src='fish.gif' width="100" height="100" >ksim's Nest</div>
...
if ($loggedin) {
 ...
 data-transition="slide" href='friends.php?r=$randstr'>Friends
 </a><br>
